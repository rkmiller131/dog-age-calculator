...
function PageContent() {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-[-3rem] sm:mt-[-3.5rem] md:mt-[-4rem]">
      ...
      <button
        onClick={toggleTheme}
        className={`${labTheme ? 'bg-blue-btn hover:text-faded-blue' : 'bg-yellow-btn hover:text-orange'} rounded-3xl border-2 border-solid border-black p-[0.5rem] pr-[1rem] pl-[1rem] text-drk-blue  shadow-[inset_4px_4px_5px_rgba(0,0,0,0.3)] font-primary mt-[1.25rem] sm:text-xl md:text-2xl md:mt-[2rem]`}
      >
