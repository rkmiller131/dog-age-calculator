...
const LabOutput: React.FC<LabOutputProps> = ({ humanAge, badInputAge }) => (
  <div aria-live="polite" className="flex flex-col w-[45%] mt-[1.5rem] text-orange xl:mt-0 xl:w-[40%]">
    ...
    <div className="flex border-2 rounded-3xl border-drk-blue justify-between p-[0.5rem] items-center cursor-not-allowed xl:p-[1.5rem]">
      ...
      <span className="text-drk-blue border-l border-drk-blue pl-[0.5rem] pr-[0.5rem] md:text-xl xl:text-3xl">Yrs</span>
    </div>
  </div>
);
